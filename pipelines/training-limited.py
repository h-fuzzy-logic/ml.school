...
from common import (
    ...
    build_features_limited_transformer, 
    build_model,
...
class TrainingLimited(FlowSpec, DatasetMixin):
    """Training pipeline.
    ...
    def start(self):
        ...
        self.data = self.load_dataset_limited()
    ...
    def transform_fold(self):
        ...
        features_transformer = build_features_limited_transformer()
    ...
    def transform(self):
        ...
        self.features_transformer = build_features_limited_transformer()
